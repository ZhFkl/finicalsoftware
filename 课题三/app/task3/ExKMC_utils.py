...
def plot_kmeans(kmeans, x_data, filename):
    ...
    for c in range(k):
        ...
        plt.scatter([center[0]], [center[1]], c="white", marker='' % c, s=350, linewidths=.5, zorder=10,
                    edgecolors='black')
...
def plot_tree_boundary(cluster_tree, k, x_data, kmeans, filename, plot_mistakes=False):
    cmap = plt.cm.get_cmap('PuBuGn')
    ...
    for c in range(k):
        ...
        print(c, center)
        # plt.scatter([center[0]], [center[1]], c="white", s=350, linewidths=.5, zorder=10, edgecolors='black')
        plt.scatter([center[0]], [center[1]], c="white", marker=c, s=350, linewidths=.5, zorder=10, edgecolors='black')
